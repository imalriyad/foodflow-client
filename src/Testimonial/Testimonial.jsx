      ...
      <div id="testimonial" className="py-6 px-4 max-w-screen-xl mx-auto">
        ...
        <Marquee pauseOnHover={true}>
          <div className="flex justify-around gap-5">
            <div className=" group hover:bg-mainColor hover:text-light p-6 cursor-pointer duration-200 rounded-xl w-[400px] drop-shadow-xl bg-light ">
              ...
              <p className="mt-5 italic font-light text-dark group-hover:text-light text-sm">
